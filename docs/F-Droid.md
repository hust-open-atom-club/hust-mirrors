...
F-Droid 是一个 Android 平台上 FOSS（Free and Open Source Software，自由开源软件）的目录，并提供下载安装支持。使用客户端可以更轻松地浏览、安装及跟进设备上的应用更新。这是一个 f-droid.org 上安卓自由软件的镜像。
...
如果您无法进入 f-droid.org ，也可以点击[这里](https://mirrors.hust.edu.cn/fdroid/repo/org.fdroid.fdroid_1023051.apk)在本站下载 F-Droid 客户端。

## 引用

1. [使用帮助 - F-Driod](https://mirrors.hust.edu.cn/fdroid/repo/)
