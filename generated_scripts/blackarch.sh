...
uninstall() {
	...
	if [ -f "${_backup_dir}/blackarch_1_1.bak" ]; then
		set_sudo
		$sudo cp "${_backup_dir}/blackarch_1_1.bak" "/etc/pacman.conf" 2>/dev/null || true
