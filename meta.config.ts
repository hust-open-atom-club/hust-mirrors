...
const mirrors: MirrorMeta[] = [
  ...
  { id: 'mxlinux-isos', description: 'MXLinux 镜像仓库', helpID: 'mxlinux', anchorID: 'cd' },
  { id: 'radxa-deb', description: '为 RadxaOS 独有的软件包提供的额外的仓库的镜像源。', supportCli: true, cliID: 'radxa-deb' },
